...
namespace UXI.GazeToolkit.Serialization.Reactive.Extensions
{
    ...
    {
        public static IObservable<object> ReadInputAsObservable(DataIO io, string filePath, FileFormat fileFormat, Type dataType, SerializationSettings configuration)
        {
        ...
        public static IObservable<object> WriteOutput(DataIO io, IObservable<object> data, string filePath, FileFormat fileFormat, Type dataType, SerializationSettings configuration)
        {
            FileFormat format = io.EnsureCorrectFileFormat(filePath, fileFormat);
